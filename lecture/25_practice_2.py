...
df1 = pd.read_csv('data/13_diecasting_small.csv')
df1.info()
...
s.info()
s_boolean = ( s >= 230 )
s_boolean.info() # dtypes: bool(1) -> Boolean Serise
...
# 컬럼 요구하는 [] 사이에 넣어주면, 각 줄마다 비교로 T인 경우만 추려 새로운 DF 생성ㄴ
df1_sub = df1[df1['실린더압력'] >= 230]
df1_sub.info()
